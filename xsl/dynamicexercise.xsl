...
<xsl:template match="de-parameter" mode="webwork-setup">
    ...
    <xsl:choose>
        ...
        <xsl:when test="@random='uniform'">
            <xsl:call-template name="random-parameter-uniform" />
        </xsl:when>
        <xsl:otherwise>
...
<!-- WeBWorK: Generate a discrete random parameter. -->
<!-- @min: lowest value -->
<!-- @max: highest value -->
...
<!-- WeBWorK: Generate a uniform random parameter. -->
<!-- @min: lowest value -->
<!-- @max: highest value -->
<xsl:template name="random-parameter-uniform">
    <xsl:variable name="param-rnd-min">
        <xsl:choose>
            <xsl:when test="@min">
                <xsl:value-of select="@min"/>
